...
<p align="center">
  ...
  <a href="https://t.me/Noctra_app"><b>Telegram Community (@Noctra_app)</b></a> &bull;
...
- **Volume handling deep-audit fixes**: the volume slider no longer cancels sleep fades or race track-change fades; phone-call ducking can no longer leave a track stuck at 20% volume; sleep timer fades from the correct level.
- **Queue & restore fixes**: Previous wraps around at queue start; resume only reuses a saved position when it belongs to the restored song.
