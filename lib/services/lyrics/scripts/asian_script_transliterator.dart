class AsianScriptTransliterator {
  ...
  static const Map<String, String> _chineseCommonPinyin = {
    ...
    '看': 'kan', '听': 'ting', '去': 'qu', '走': 'zou', '过': 'guo',
    '对': 'dui', '起': 'qi', '等': 'deng', '问': 'wen', '知': 'zhi',
    '道': 'dao', '回': 'hui', '家': 'jia', '花': 'hua', '水': 'shui',
    '海': 'hai', '山': 'shan', '眼': 'yan', '声': 'sheng', '音': 'yin',
    '分': 'fen', '手': 'shou', '笑': 'xiao', '泪': 'lei', '哭': 'ku',
    '念': 'nian', '忘': 'wang', '记': 'ji', '给': 'gei', '让': 'rang',
    '最': 'zui', '更': 'geng', '很': 'hen', '太': 'tai', '真': 'zhen',
    '只': 'zhi', '又': 'you', '再': 'zai', '还': 'hai', '从': 'cong',
    '向': 'xiang', '自': 'zi', '己': 'ji', '如': 'ru', '果': 'guo',
    '何': 'he', '怎': 'zen', '么': 'me', '样': 'yang', '里': 'li',
    '谁': 'shui', '什': 'shen', '表': 'biao', '那': 'na', '留': 'liu',
    '飞': 'fei', '随': 'sui', '愿': 'yuan', '别': 'bie', '深': 'shen',
    '痛': 'tong', '永': 'yong', '远': 'yuan', '一': 'yi', '二': 'er',
