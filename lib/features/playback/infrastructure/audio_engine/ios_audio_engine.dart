...
/// iOS-specific implementation of [PlaybackEngine].
///
/// Configures audio session semantics (AVAudioSessionCategoryPlayback) and interruption safety.
class IOSAudioEngine implements PlaybackEngine {
  ...
  IOSAudioEngine({AudioPlayer? player})
