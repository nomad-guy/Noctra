...
/// Desktop-specific implementation of [PlaybackEngine] for Windows and Linux.
///
/// Wraps [AudioPlayer] with desktop media controls and background persistence.
class DesktopAudioEngine implements PlaybackEngine {
  ...
  DesktopAudioEngine({AudioPlayer? player})
  ...
  Future<void> load(String uri, {Duration? initialPosition}) async {
    try {
      ...
      _currentState = EnginePlaybackState(
        isPlaying: false,
        status: EnginePlaybackStatus.error,
