...
class ArtistScreen extends ConsumerStatefulWidget {
  ...
  const ArtistScreen(
      {super.key, required this.artistName, this.artistImageUrl});
        ...
        child: CustomScrollView(
          ...
          slivers: [
                ...
                child: GlassCard(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                          _artistMetadata?.shortDescription ??
                              '${tracks.length} Master Releases • 320 kbps High-Fidelity',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 12,
                              color: isDark ? Colors.white54 : Colors.black54)),
                      if (_artistMetadata?.bio != null &&
                          _artistMetadata!.bio!.isNotEmpty) ...[
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      final albTracks =
                          (alb['tracks'] as List?)?.cast<Song>() ?? [];
                      return GestureDetector(
                        onTap: () {
                          if (albTracks.isNotEmpty) {
                            audioPlayer.playSong(albTracks.first,
                                newQueue: albTracks);
                          }
                        },
                        child: Container(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, i) {
                      ...
                      final isDownloaded =
                          repo.downloads.any((s) => s.id == song.id) ||
                              song.isDownloaded;
                      final downloadingSet =
                          ref.watch(downloadingSongsProvider);
                      ...
                      return Padding(
                        ...
                        child: GlassCard(
                          ...
                          onTap: () =>
                              audioPlayer.playSong(song, newQueue: tracks),
                          child: Row(
                            children: [
                              ClipRRect(
                              ...
                              IconButton(
                                ...
                                onPressed: isDownloaded || isDownloading
                                    ...
                                    : () async {
                                        final res =
                                            await MusicService.downloadTrack(
                                                song);
                                        if (res != null) {
            ...
            if (_discography != null &&
                _discography!.similarArtists.isNotEmpty) ...[
              SliverToBoxAdapter(
                child: Padding(
